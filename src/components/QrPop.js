...
const QrPop = (props) => {
    ...
    if (props.data.checkin_status === 0)
        ...
        txt = '请于' + props.data.bookingTime + '<br/>到店签到<br/><p class="bip">签到二维码将于<br/>预约时间后10分钟失效<br/>仅限本人使用<br/>且仅能只用1次</p>'
    else
        txt = '请于' + props.data.bookingTime + '<br/>到店签到<br/><p class="bip">超过预约时间10分钟<br/>签到二维码将会失效</p><p class="bipErr">二维码已失效</p>'
